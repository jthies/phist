...
int phist_Sidfunc(ghost_gidx_t row, ghost_lidx_t* len, ghost_gidx_t* cols, void* vals)
{
  *len=1;
  cols[0]=row;
  ((float*)vals)[0]=1.0f;
...
int phist_Didfunc(ghost_gidx_t row, ghost_lidx_t* len, ghost_gidx_t* cols, void* vals)
{
  *len=1;
  cols[0]=row;
  ((double*)vals)[0]=1.0;
...
int phist_Cidfunc(ghost_gidx_t row, ghost_lidx_t* len, ghost_gidx_t* cols, void* vals)
{
  *len=1;
  cols[0]=row;
...
int phist_Zidfunc(ghost_gidx_t row, ghost_lidx_t* len, ghost_gidx_t* cols, void* vals)
{
  *len=1;
  cols[0]=row;
