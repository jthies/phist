...
set(MPIRUN_COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${MPIEXEC_MAX_NUMPROCS} ${MPIEXEC_PREFLAGS} ${TEST_ENV})

# Jacobi-Davidson solver
set(TEST_COMMAND ${MPIRUN_COMMAND} ./drivers/phist_Dsubspacejada  spinSZ14 I 1 10 SR 1e-8 28 4 16 32 4 8 0.0 0 1 1 )
add_test(NAME Dsubspacejada COMMAND ${TEST_COMMAND})


# iterative solvers: BiCGstab and IDR(s)
set(TEST_COMMAND ${MPIRUN_COMMAND} ./drivers/phist_Dblockedidrs matpde64 0 288 1e-6)
add_test(NAME Dbicgstab COMMAND ${TEST_COMMAND})
...
if (PHIST_KERNEL_LIB_BUILTIN OR PHIST_KERNEL_LIB_EPETRA)
    ...
    add_test(NAME Dcarp_cg_spin_complex_shifts COMMAND ${MPIRUN_COMMAND}
        ./drivers/phist_carp_cg spinSZ14 imaginary_shifts.txt 1 1 1e-6 350 1.2 )
endif()
