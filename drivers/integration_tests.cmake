...
add_test(NAME Dsubspacejada COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_Dsubspacejada  spinSZ14 I 1 10 SR 1e-8 28 4 16 32 4 8 0.0 0 1 1)


# iterative solvers: BiCGstab and IDR(s)
add_test(NAME Dbicgstab COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_Dblockedidrs matpde64 0 288 1e-6)

add_test(NAME Didr1 COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_Dblockedidrs matpde64 1 288 1e-6)

add_test(NAME Didr2 COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_Dblockedidrs matpde64 2 262 1e-6)

add_test(NAME Didr4 COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_Dblockedidrs matpde64 4 234 1e-6)

# GMRES
add_test(NAME Dgmres COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_Dblockedgmres matpde64 150 1e-6 1 100)

add_test(NAME Dgmres_restarted COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
...
if (PHIST_HAVE_IFPACK OR PHIST_HAVE_IFPACK2)
    ...
    add_test(NAME Dgmres_ilu  COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
...
if (PHIST_KERNEL_LIB_BUILTIN OR PHIST_KERNEL_LIB_EPETRA)
    ...
    add_test(NAME Dcarp_cg_graphene COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
        ./drivers/phist_carp_cg graphene128x64.mm none 1 1 1e-12 350 1.0)
    ...
    add_test(NAME Dcarp_cg_spin_complex_shifts COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} {PHIST_TEST_DRIVERS_NUMPROCS} ${TEST_ENV}
