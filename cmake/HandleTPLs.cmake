...
if (PHIST_KERNEL_LIB STREQUAL "eigen")
  ...
  set(TPL_ENABLE_Eigen3 OFF CACHE BOOL "Try to find and use Eigen3 (if supported by the kernel library).")
endif()
if (PHIST_KERNEL_LIB STREQUAL "magma")
  set(TPL_MAGMA_REQUIRED ON)
else()
  set(TPL_ENABLE_MAGMA OFF CACHE BOOL "Try to find and use MAGMA (if supported by the kernel library).")
endif()
if (PHIST_KERNEL_LIB STREQUAL "petsc")
  set(TPL_PETSC_REQUIRED ON)
else()
  set(TPL_ENABLE_PETSC OFF CACHE BOOL "Try to find and use PETSC (if supported by the kernel library).")
endif()
