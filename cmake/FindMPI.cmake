# this file was copied from CMake 3.5.2 and modified in a single way: we first try the regular compiler
# before doing anything else. That way one can always set e.g. CC=mpicc, CXX=mpicxx etc and expect things
# to work even on platforms like Cray.
#.rst:
# FindMPI
# -------
#
...
foreach (lang C CXX Fortran)
  if (CMAKE_${lang}_COMPILER_WORKS)
    ...
    if (MPI_${lang}_COMPILER)
      ...
      # see if we can create an MPI executable. This is in contrast to what
      # the CMake FindMPI module usually does, but we decided to first of all
      # trust the system installation to do the right thing.
