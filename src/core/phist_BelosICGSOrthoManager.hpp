#ifndef PHIST_BELOS_ICGS_ORTHOMANAGER_HPP
#define PHIST_BELOS_ICGS_ORTHOMANAGER_HPP
...
namespace Belos {
  ...
  class ICGSOrthoManager<phist::BelosMV<ScalarType>,phist::types<ScalarType>::linearOp> :
    public MatOrthoManager<ScalarType,phist::BelosMV<ScalarType>,phist::types<ScalarType>::linearOp>,
    public Teuchos::ParameterListAcceptorDefaultBase
  {
  private:
    typedef phist::BelosMV<ScalarType> MV;
    typedef phist::types<ScalarType>::linearOp OP;
