...
#include "phist_std_typedefs.hpp"
  ...
  *nEig = 0;                  //< already converged number of eigenvalues
  ...
  PHIST_CHK_IERR(SUBR( mvec_view_block  ) (t_,  &t,   0,     k,         ierr), *ierr);
  ...
  // run arnoldi
  {
    mvec_ptr_t Htmp = NULL;
    PHIST_CHK_IERR(SUBR( sdMat_view_block ) (H, &Htmp, 0, minBase, 0, minBase-1, ierr), *ierr);

    PHIST_CHK_IERR(SUBR( simple_arnoldi ) (A_op, v0, V, Htmp, minBase, ierr), *ierr);
