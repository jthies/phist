...
void dgemm_sB_self_prec_4(int nrows, const double *restrict x, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
...
// more accurate gemm product x'x AVX2 kernel
void dgemm_sB_self_prec_2(int nrows, const double *restrict x, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
...
void dgemm_sB_prec_4_4(int nrows, const double *restrict x, const double *restrict y, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
...
// more accurate gemm product x'y AVX2 kernel
void dgemm_sB_prec_2_2(int nrows, const double *restrict x, const double *restrict y, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
...
// more accurate gemm product x'y AVX2 kernel
void dgemm_sB_prec_4_2(int nrows, const double *restrict x, const double *restrict y, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
...
// more accurate gemm product x'y AVX2 kernel
void dgemm_sB_prec_4_1(int nrows, const double *restrict x, const double *restrict y, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
...
// more accurate gemm product x'y AVX2 kernel
void dgemm_sB_prec_4_k(int nrows, int k, const double *restrict x, const double *restrict y, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
...
// more accurate gemm product x'y AVX2 kernel
void dgemm_sB_prec_2_k(int nrows, int k, const double *restrict x, const double *restrict y, double *restrict res, double *restrict resC)
{
  if( !is_aligned(x,32) )
  {
    printf("not aligned %lx\n", (uintptr_t)(void*)x);
