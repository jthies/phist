...
!flush(6)
  ...
  subroutine phist_DcrsMat_read_mm(A_ptr, filename_len, filename_ptr, ierr) &
...
!end do
  ...
  !==================================================================================
  !> read MatrixMarket file
  subroutine phist_DcrsMat_create_fromRowFunc(A_ptr, nrows, ncols, maxnne_per_row, rowFunc_ptr, ierr) &
