...
*/
#ifndef PHIST_ANASAZI_SVQB_ORTHOMANAGER_HPP

#ifdef ANASAZI_SVQB_ORTHOMANAGER_HPP
# error "someone else included the original version of AnasaziSVQBOrthoManager.hpp, which should not be used in PHIST"
#endif

#define PHIST_ANASAZI_SVQB_ORTHOMANAGER_HPP
