function [D,V,Q,R]=jdqri(A,v0,opts)
%function [D,v]=jdqri(A,v0,opts,varargin)          
% single-vector JDQR for a few interior eigenpairs.     
% JDQR method for kmax interior eigenvalues, with       
